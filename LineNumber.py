...
class LineNumberCanvas(tk.Canvas):
    ...
    def re_render(self):
        ...
        while True :
            ...
            id = self.create_text(2,y,anchor="nw", text=linenum, fill="white")
...
class LineMain():
    ...
    def _set_(self):
        self.linenumbers = LineNumberCanvas(self.master, width=30, bg="#515151", bd=0, highlightthickness=2, highlightbackground="#666666", relief='ridge')
